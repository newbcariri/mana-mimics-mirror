...
function CheckoutPage() {
  ...
  if (loading) return <div className="min-h-screen bg-background"><SiteHeader /><div className="text-center py-20 text-muted-foreground">Carregando...</div></div>;
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-8">
          ...
          <aside className="bg-muted/40 rounded-xl p-6 h-fit sticky top-32 space-y-4">
            ...
            <button onClick={placeOrder} disabled={placing} className="w-full h-12 bg-success text-success-foreground rounded-md font-bold hover:bg-success/90 disabled:opacity-50">
