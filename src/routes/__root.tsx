...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Conjunto Básico Poliamida Vermelho — FlexFit Brasil" },
      ...
      { property: "og:title", content: "Conjunto Básico Poliamida Vermelho — FlexFit Brasil" },
      { property: "og:description", content: "Top + legging em poliamida com proteção UV 50+, alta compressão e zero transparência." },
